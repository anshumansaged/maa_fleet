...
function NavLinks() {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Link to="/" className="p-2.5 rounded-full bg-white/60 backdrop-blur-xl border border-white/80 shadow-sm text-slate-400 hover:text-rose-500 hover:bg-rose-50 transition-all" title="Logout">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="glass-panel px-6 py-3 flex justify-between items-center !rounded-full">
              <Link to="/" className="flex items-center space-x-3 group">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-brand-500 to-pink-500 flex items-center justify-center shadow-lg shadow-brand-500/30 text-white transition-transform group-hover:scale-110 duration-300">
